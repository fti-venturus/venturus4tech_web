...
//Cria endpoint para retornar mensagens
...
app.listen(3001, function(){
    console.log('Endpoint ouvindo porta 3001');
});
...
server.listen(3000, '0.0.0.0', (err) => {
  console.log('Servidor Socket ouvindo porta 3000');
});
...
function saveMessage(message, cb) {
  ...
  newMessage.author = message.author || 'Sem autor';
  newMessage.message = message.message || 'Sem mensagem';
